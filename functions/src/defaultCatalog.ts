...
export const defaultReviews: Array<{ id: string; [key: string]: unknown }> = [];

export const defaultFaqs: Array<{ id: string; [key: string]: unknown }> = [];
...
export const defaultPopups: Array<{ id: string; [key: string]: unknown }> = [];
